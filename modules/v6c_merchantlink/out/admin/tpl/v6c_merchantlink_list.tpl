[{*--
  * Use shop_list.tpl as a basis for merging diffs on updates
--*}]
...
[{include file="_formparams.tpl" cl="v6c_merchantlinklist" lstrt=$lstrt actedit=$actedit oxid=$oxid fnc="" language=$actlang editlanguage=$actlang delshopid="" updatenav=""}]
...
{   parent.parent.sShopTitle   = "[{$actshopobj->oxshops__oxname->getRawValue()|oxaddslashes}]";
    parent.parent.sMenuItem    = "[{ oxmultilang ident="V6C_MENUITEM" }]";
    parent.parent.sMenuSubItem = "[{ oxmultilang ident="V6C_MENUSUBITEM_MERCHLNK" }]";
