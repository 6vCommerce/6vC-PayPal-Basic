...
<<<<<<< HEAD
    'V6C_EMAIL_ORDER_OWNER_PAYMENTEXTRA'        => "ZusÃ¤tzliche Info zum PayPal-Portal:",
    ...
    'V6C_PAGE_CHECKOUT_REDIRECT_SUBMITTING'	    => "Wenn Sie nicht innerhalb von 10 Sekunden weitergeleitet werden, kÃ¶nnen Sie den Button unten benutzen, um die Seite des sicheren PayPal-Portals manuell aufzurufen.", // NOTE: this is fed into a javascript write function, so single quotes must be escaped.
    'V6C_PAGE_CHECKOUT_REDIRECT_NOJAVA'         => "Ihr Browser unterstÃ¼tzt die automatisches Weiterleitung zum sicheren PayPal-Portal nicht. Bitte benutzen Sie den Button unten, um manuell fortzufahren.",
    ...
    'V6C_PAGE_CHECKOUT_REDIRECT_ERRORDESC'      => 'Sie kÃ¶nnen versuchen, den Weiter-Button unten noch einmal zu benutzen, sonst versuchen sie es bitte spÃ¤ter noch einmal. Wir entschuldigen uns fÃ¼r diese Unannehmlichkeit.',
    'V6C_PAGE_CHECKOUT_REDIRECT_CANCEL'	        => 'Das Sammeln der Zahlungsinformationen wurde unterbrochen',
    'V6C_PAGE_CHECKOUT_REDIRECT_CANCELDESC'     => 'Sie haben das PayPal-Portal verlassen, bevor alle Zahlungsinformationen gesammelt werden konnten. Sie kÃ¶nnen den Weiter-Button unten benutzen, um zum PayPal-Portal zurÃ¼ckzukehren oder es spÃ¤ter erneut versuchen.',
    'V6C_PAGE_CHECKOUT_REDIRECT_CONTBTN'        => 'Weiter',
    'V6C_PAGE_CHECKOUT_THANKYOU_CONFIRMFAIL'    => 'Ihre Zahlung wurde von unserem Zahlungsportal durchgefÃ¼hrt aber die BestellbestÃ¤tigung schlug fehl. Unser Team wurde darÃ¼ber informiert und wird sich schnellstmÃ¶glich darum kÃ¼mmern. Wir treten mit Ihnen in Kontakt, falls wir Ihre Bestellung nicht ausfÃ¼hren kÃ¶nnen.',
    'V6C_PAGE_CHECKOUT_PAYMENT_ERRINIT'	        => 'Fehler wÃ¤hrend der Ãœbertragung der Informationen zum sicheren PayPal-Portal. Bitte versuchen Sie es erneut oder kontaktieren Sie uns, wenn der Fehler weiterhin auftritt.',
    ...
    'V6C_THKYOU_NOORDER'	                    => 'Ein interner Fehler ist aufgetreten: Die bestÃ¤tigte Bestellung konnte nicht in der Datenbank gefunden werden.',
    'V6C_THKYOU_NOSESSION'                      => '',
    'V6C_PAYPAL_NOCONNECT'                      => 'Konnte PayPal-Server nicht erreichen.',
    'V6C_PAYPAL_UNKWNRQ'                        => 'Unbekannter BestÃ¤tigungs-Typ.',
    'V6C_PAYPAL_MISSINGPARMS'                   => 'Angeforderte Daten konnten nicht von PayPal empfangen werden.',
    'V6C_PAYPAL_BADID'                          => 'VerkÃ¤ufer-ID in der Anfrage ist anders als die VerkÃ¤ufer-ID des Ziels.',
    'V6C_PAYPAL_PDTFAIL'                        => 'Fehler beim Empfang der PDT-Ãœbertragungsdaten vom PayPal-Server.',
    'V6C_PAYPAL_IPNINVALID'                     => 'Fehler beim Empfang der IPN-Ãœbertragungsdaten vom PayPal-Server.',
    ...
    'V6C_ORDER_ERRBSKLDFAIL'                    => 'Fehler beim Laden des Warenkorbs fÃ¼r den Benutzer, der dieser Bestellung zugeordnet ist.',
    'V6C_ORDER_ERRPAYLDFAIL'                    => 'Fehler beim Laden der Zahlung aus der Bestellinformation.',
    'V6C_ORDER_ERRPAYMISMATCH'                  => 'Der Betrag, der vom PayPal-Portal bestÃ¤tigt wurde, ist anders als der Betrag der Bestellung.',
=======
...
>>>>>>> Changed encoding from UTF-8 to ISO-8859-15 (Western ISO Latin 9)
);
