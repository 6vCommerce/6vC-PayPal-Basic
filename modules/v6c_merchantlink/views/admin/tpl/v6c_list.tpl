...
[{include file="_formparams.tpl" cl="v6c_nashoplist" lstrt=$lstrt actedit=$actedit oxid=$oxid fnc="" language=$actlang editlanguage=$actlang delshopid="" updatenav=""}]
...
{   parent.parent.sShopTitle   = "[{$actshopobj->oxshops__oxname->getRawValue()|oxaddslashes}]";
    ...
    parent.parent.sMenuSubItem = "[{ oxmultilang ident="V6C_MENUSUBITEM_NASHOP" }]";
